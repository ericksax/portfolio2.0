    ...
    <section className="max-w-4xl mx-auto">
      ...
      <div className="text-gray-400 text-lg border border-gray-800 rounded-lg p-4 mt-10">
        <p className="ident-8 text-balance text-justify">
          ...
          superioridade, mas sim de encontrar a ferramenta certa para o trabalho
          certo. Linguagens diferentes podem alcançar o mesmo objetivo de
          maneiras diversas. Para mim, é sobre processos e pessoas, buscando
          facilidade, simplicidade e soluções práticas. Vejo as linguagens de
          programação como uma caixa de ferramentas, onde escolhemos a
          ferramenta certa para a tarefa específica. Não é o fim em si, mas o
